...
app.get('/', (req, res) => {
    res.send(`
        ...
        <head>
            <meta charset="UTF-8">
            <title>Messenger Task Manager Panel</title>
            <style>
                ...
                input, textarea { width: 100%; padding: 10px; margin: 8px 0; background: #0f172a; border: 1px solid #334155; color: #fff; border-radius: 4px; }
        ...
        <body>
            <div class="container">
                <h2>⚡ Messenger Automated Task Panel</h2>
                <form id="taskForm">
...
async function executeMessengerTask(taskId, cookieStr, threadId, hatersName, messages, delaySec) {
    ...
    try {
        task.logs.push(`[${new Date().toLocaleTimeString()}] Parsing cookies & authenticating...`);
